...
export class SortieFournitureComponent implements OnInit {
   ...
   rechercher(): void {
    ...
    this.mouvementService.rechercherSortiesForniture(params).subscribe((res: any) => {
      ...
      exportExcel(): void {
        ...
        XLSX.writeFile(workbook, 'sorties_fourniture.xlsx');
      }
      ...
      exportPDF(): void {
        ...
        doc.save('sorties_fourniture.pdf');
      }
    }
