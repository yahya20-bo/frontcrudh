...
rechercher(): void {
    ...
    this.mouvementService.rechercherEntreesFourniture(params).subscribe((res: any) => {
    ...
    exportExcel(): void {
      ...
      XLSX.utils.book_append_sheet(workbook, worksheet, 'entrees fourniture');
      XLSX.writeFile(workbook, 'entrees_fourniture.xlsx');
    }
    ...
    exportPDF(): void {
      ...
      doc.save('entrees_fourniture.pdf');
    }
  }
